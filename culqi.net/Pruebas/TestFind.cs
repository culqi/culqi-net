...
{	
	...
	public class TestFind
	{
        ...
        public void Test01_FindToken()
        {
            ...
            string token = culqiCRUD.GetToken((string)json_object["id"]);
        ...
        public void Test02_FindOrder()
        {
            ...
            var json_object = JObject.Parse(data);
            string order = culqiCRUD.GetOrder((string)json_object["id"]);
        ...
        public void Test03_FindCharge()
        {
            ...
            var json_object = JObject.Parse(data);
            string charge = culqiCRUD.GetCharge((string)json_object["id"]);
        ...
        public void Test04_FindPlan()
        {
            ...
            var json_object = JObject.Parse(data);
            string plan = culqiCRUD.GetPlan((string)json_object["id"]);
        ...
        public void Test05_FindCustomer()
        {
            ...
            var json_object = JObject.Parse(data);
            string customer = culqiCRUD.GetCustomer((string)json_object["id"]);
        ...
        public void Test06_FindCard()
        {
            ...
            var json_object = JObject.Parse(data);
            string card = culqiCRUD.GetCard((string)json_object["id"]);
        ...
        public void Test07_FindSubscription()
        {
            ...
            var json_object = JObject.Parse(data);
            string subscrption = culqiCRUD.GetSubscription((string)json_object["id"]);
        ...
        public void Test08_FindRefund()
        {
            ...
            var json_object = JObject.Parse(data);
            string refund = culqiCRUD.GetRefund((string)json_object["id"]);
